...
public final class ChangelogsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsRequest,
      com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsResponse> getListChangelogsMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsRequest,
      com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsResponse> getListChangelogsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsRequest, com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsResponse> getListChangelogsMethod;
      ...
      synchronized (ChangelogsGrpc.class) {
        if ((getListChangelogsMethod = ChangelogsGrpc.getListChangelogsMethod) == null) {
          ChangelogsGrpc.getListChangelogsMethod = getListChangelogsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsRequest, com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsResponse>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.dialogflow.cx.v3beta1.GetChangelogRequest,
      com.google.cloud.dialogflow.cx.v3beta1.Changelog> getGetChangelogMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.dialogflow.cx.v3beta1.GetChangelogRequest,
      com.google.cloud.dialogflow.cx.v3beta1.Changelog> getGetChangelogMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.dialogflow.cx.v3beta1.GetChangelogRequest, com.google.cloud.dialogflow.cx.v3beta1.Changelog> getGetChangelogMethod;
      ...
      synchronized (ChangelogsGrpc.class) {
        if ((getGetChangelogMethod = ChangelogsGrpc.getGetChangelogMethod) == null) {
          ChangelogsGrpc.getGetChangelogMethod = getGetChangelogMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.dialogflow.cx.v3beta1.GetChangelogRequest, com.google.cloud.dialogflow.cx.v3beta1.Changelog>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetChangelog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.dialogflow.cx.v3beta1.GetChangelogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static abstract class ChangelogsImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void listChangelogs(com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getChangelog(com.google.cloud.dialogflow.cx.v3beta1.GetChangelogRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.dialogflow.cx.v3beta1.Changelog> responseObserver) {
  ...
  public static final class ChangelogsBlockingStub extends io.grpc.stub.AbstractBlockingStub<ChangelogsBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsResponse listChangelogs(com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsRequest request) {
     ...
     * </pre>
     */
    public com.google.cloud.dialogflow.cx.v3beta1.Changelog getChangelog(com.google.cloud.dialogflow.cx.v3beta1.GetChangelogRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ChangelogsFutureStub extends io.grpc.stub.AbstractFutureStub<ChangelogsFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsResponse> listChangelogs(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.dialogflow.cx.v3beta1.Changelog> getChangelog(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_CHANGELOGS:
          serviceImpl.listChangelogs((com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.dialogflow.cx.v3beta1.ListChangelogsResponse>) responseObserver);
          break;
        case METHODID_GET_CHANGELOG:
          serviceImpl.getChangelog((com.google.cloud.dialogflow.cx.v3beta1.GetChangelogRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.dialogflow.cx.v3beta1.Changelog>) responseObserver);
          break;
        default:
