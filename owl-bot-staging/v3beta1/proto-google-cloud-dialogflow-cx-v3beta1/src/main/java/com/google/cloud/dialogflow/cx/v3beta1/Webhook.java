    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 58: {
            com.google.cloud.dialogflow.cx.v3beta1.Webhook.ServiceDirectoryConfig.Builder subBuilder = null;
            if (webhookCase_ == 7) {
              subBuilder = ((com.google.cloud.dialogflow.cx.v3beta1.Webhook.ServiceDirectoryConfig) webhook_).toBuilder();
            }
            webhook_ =
                input.readMessage(com.google.cloud.dialogflow.cx.v3beta1.Webhook.ServiceDirectoryConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.dialogflow.cx.v3beta1.Webhook.ServiceDirectoryConfig) webhook_);
              webhook_ = subBuilder.buildPartial();
            }
            webhookCase_ = 7;
            break;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              genericWebService_ = input.readMessage(com.google.cloud.dialogflow.cx.v3beta1.Webhook.GenericWebService.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (com.google.cloud.dialogflow.cx.v3beta1.Webhook.ServiceDirectoryConfig) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
      ...
      public Builder mergeGenericWebService(com.google.cloud.dialogflow.cx.v3beta1.Webhook.GenericWebService value) {
        if (genericWebServiceBuilder_ == null) {
          if (genericWebService_ != null) {
            genericWebService_ =
              com.google.cloud.dialogflow.cx.v3beta1.Webhook.GenericWebService.newBuilder(genericWebService_).mergeFrom(value).buildPartial();
          } else {
            genericWebService_ = value;
          }
          onChanged();
