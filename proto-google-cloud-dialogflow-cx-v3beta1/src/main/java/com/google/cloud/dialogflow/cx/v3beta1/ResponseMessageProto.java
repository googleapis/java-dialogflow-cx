  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "or.proto\032\034google/protobuf/struct.proto\032\034google/api/annotations.proto\"\255\n\n"
          + "\017ResponseMessage\022H\n"
          + "\004text\030\001 \001(\01328.google.cloud.di"
          + "alogflow.cx.v3beta1.ResponseMessage.TextH\000\022*\n"
          + "\007payload\030\002 \001(\0132\027.google.protobuf.StructH\000\022g\n"
          + "\024conversation_success\030\t \001(\0132G.g"
          + "oogle.cloud.dialogflow.cx.v3beta1.ResponseMessage.ConversationSuccessH\000\022`\n"
          + "\021output_audio_text\030\010 \001(\0132C.google.cloud.dialog"
          + "flow.cx.v3beta1.ResponseMessage.OutputAudioTextH\000\022b\n"
          + "\022live_agent_handoff\030\n"
          + " \001(\0132D."
          + "google.cloud.dialogflow.cx.v3beta1.ResponseMessage.LiveAgentHandoffH\000\022b\n"
          + "\017end_interaction\030\013 \001(\0132B.google.cloud.dialogflow"
          + ".cx.v3beta1.ResponseMessage.EndInteractionB\003\340A\003H\000\022S\n\n"
          + "play_audio\030\014 \001(\0132=.google.c"
          + "loud.dialogflow.cx.v3beta1.ResponseMessage.PlayAudioH\000\022Z\n"
          + "\013mixed_audio\030\r"
          + " \001(\0132>.go"
          + "ogle.cloud.dialogflow.cx.v3beta1.ResponseMessage.MixedAudioB\003\340A\003H\000\032C\n"
          + "\004Text\022\021\n"
          ...
          + "low.cx.v3beta1.ResponseMessage.MixedAudio.Segment\032^\n"
          + "\007Segment\022\017\n"
          ...
          + "\007contentB\t\n"
          + "\007messageB\334\001\n"
          + "&com.google.cloud.dialogflow.cx.v3beta1B\024ResponseMessageProtoP\001ZDgoogle.golang.o"
