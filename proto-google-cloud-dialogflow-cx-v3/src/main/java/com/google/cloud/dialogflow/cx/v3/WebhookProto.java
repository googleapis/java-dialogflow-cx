  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\023generic_web_service\030\002 \001(\01328.google.cloud.dia"
          + "logflow.cx.v3.Webhook.GenericWebService:q\352An\n"
          + "!dialogflow.googleapis.com/Webhook\022"
          + "Iprojects/{project}/locations/{location}/agents/{agent}/webhooks/{webhook}B\t\n"
          + "\007webhook\"w\n"
          ...
          + "2=.google.cloud.dialogflow.cx.v3.WebhookRequest.FulfillmentInfo\022M\n"
          ...
          + "\031sentiment_analysis_result\030\t \001(\0132E.google.cloud.dialogflow.cx"
          + ".v3.WebhookRequest.SentimentAnalysisResult\032\036\n"
          ...
          + "H.google.cloud.dialogflow.cx.v3.WebhookRequest.IntentInfo.ParametersEntry\022\022\n\n"
          ...
          + "\003key\030\001 \001(\t\022\\\n"
          + "\005value\030\002 \001(\0132M.google.cloud.dialogflow.cx.v3.WebhookReq"
          + "uest.IntentInfo.IntentParameterValue:\0028\001\032;\n"
          ...
          + "2B.google.cloud.dialogflow.cx.v3.WebhookResponse.FulfillmentResponse\022:\n"
          ...
          + "cloud.dialogflow.cx.v3.WebhookResponse.FulfillmentResponse.MergeBehavior\"H\n\r"
          ...
          + "\010FormInfo\022V\n"
          + "\016parameter_info\030\002 \003(\0132>.google.cloud.dialog"
          + "flow.cx.v3.PageInfo.FormInfo.ParameterInfo\032\253\002\n\r"
          + "ParameterInfo\022\024\n"
          + "\014display_name\030\001 \001(\t\022\020\n"
          + "\010required\030\002 \001(\010\022\\\n"
          + "\005state\030\003 \001(\0162M.go"
          + "ogle.cloud.dialogflow.cx.v3.PageInfo.FormInfo.ParameterInfo.ParameterState\022%\n"
          ...
          + "parameters\030\002 \003(\0132:."
          + "google.cloud.dialogflow.cx.v3.SessionInfo.ParametersEntry\032I\n"
          + "\017ParametersEntry\022\013\n"
          + "\003key\030\001 \001(\t\022%\n"
          ...
          + "/{parent=projects/*/locations/*/agents/*}/webhooks\332A\006parent\022\254\001\n\n"
          + "GetWebhook\0220.google.cloud.dialogflow.cx.v3.GetWebhookReq"
          + "uest\032&.google.cloud.dialogflow.cx.v3.Web"
          + "hook\"D\202\323\344\223\0027\0225/v3/{name=projects/*/locations/*/agents/*/webhooks/*}\332A\004name\022\305\001\n\r"
          ...
          + "parent=projects/*/locations/*/agents/*}/webhooks:\007webhook\332A\016parent,webhook\022\322\001\n\r"
          ...
          + "ts/*/webhooks/*}:\007webhook\332A\023webhook,update_mask\022\242\001\n\r"
          ...
          + "ud-platform,https://www.googleapis.com/auth/dialogflowB\277\002\n"
          ...
          + "logflow.Cx.V3\352\002!Google::Cloud::Dialogflow::CX::V3\352A|\n"
