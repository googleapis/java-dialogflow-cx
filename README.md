...
The Maven artifact coordinates (`com.google.cloud:google-cloud-dialogflow-cx`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-dialogflow-cx:0.21.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dialogflow-cx" % "0.21.0"
```
